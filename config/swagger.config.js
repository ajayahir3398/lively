      ...
      schemas: {
        ...
        Course: {
          ...
          properties: {
            ...
            activity_id: { type: 'integer', description: 'Associated Activity ID', example: 1 },
            ...
            description: { type: 'string', description: 'Course description', example: 'Basic programming concepts' },
        ...
        QuickSession: {
          ...
          properties: {
            ...
            description: { type: 'string', description: 'Session description', example: 'Quick demonstration' },
